...
public class IotPackageImpl extends EPackageImpl implements IotPackage
{
   ...
   * @see org.slf.iot.IotPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * @generated
   */
  public EReference getModel_Dispositivos()
  {
   ...
   * @generated
   */
  public EAttribute getDispositivo_Name()
  {
   ...
   * @generated
   */
  public EReference getDispositivo_SuperType()
  {
    return (EReference)dispositivoEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getDispositivo_Etiquetas()
  {
    return (EReference)dispositivoEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getDispositivo_Estados()
  {
    return (EReference)dispositivoEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getDispositivo_Eventos()
  {
    return (EReference)dispositivoEClass.getEStructuralFeatures().get(4);
  }
   ...
   * @generated
   */
  public EReference getDispositivo_Transiciones()
  {
    return (EReference)dispositivoEClass.getEStructuralFeatures().get(5);
  }
   ...
   * @generated
   */
  public EAttribute getEtiqueta_TypeName()
  {
    return (EAttribute)etiquetaEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getEtiqueta_Name()
  {
    return (EAttribute)etiquetaEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EAttribute getEtiqueta_Value()
  {
    return (EAttribute)etiquetaEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EAttribute getEvento_TypeName()
  {
   ...
   * @generated
   */
  public EReference getEstado_Elementos()
  {
   ...
   * @generated
   */
  public EReference getTransicion_Evento()
  {
   ...
   * @generated
   */
  public EReference getTransicion_Estado()
  {
   ...
   * @generated
   */
  public EReference getIfBlock_Elementos()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(modelEClass, MODEL__DISPOSITIVOS);

    dispositivoEClass = createEClass(DISPOSITIVO);
    createEAttribute(dispositivoEClass, DISPOSITIVO__NAME);
    createEReference(dispositivoEClass, DISPOSITIVO__SUPER_TYPE);
    createEReference(dispositivoEClass, DISPOSITIVO__ETIQUETAS);
    createEReference(dispositivoEClass, DISPOSITIVO__ESTADOS);
    createEReference(dispositivoEClass, DISPOSITIVO__EVENTOS);
    createEReference(dispositivoEClass, DISPOSITIVO__TRANSICIONES);

    etiquetaEClass = createEClass(ETIQUETA);
    createEAttribute(etiquetaEClass, ETIQUETA__TYPE_NAME);
    createEAttribute(etiquetaEClass, ETIQUETA__NAME);
    createEAttribute(etiquetaEClass, ETIQUETA__VALUE);

    eventoEClass = createEClass(EVENTO);
    createEAttribute(eventoEClass, EVENTO__TYPE_NAME);
    createEAttribute(eventoEClass, EVENTO__NAME);

    estadoEClass = createEClass(ESTADO);
    createEAttribute(estadoEClass, ESTADO__NAME);
    createEReference(estadoEClass, ESTADO__ELEMENTOS);

    transicionEClass = createEClass(TRANSICION);
    createEReference(transicionEClass, TRANSICION__EVENTO);
    createEReference(transicionEClass, TRANSICION__ESTADO);
    ...
    createEReference(ifBlockEClass, IF_BLOCK__ELEMENTOS);
  ...
  public void initializePackageContents()
  {
    ...
    ifStatementEClass.getESuperTypes().add(this.getAbstractElement());
    ...
    initEReference(getModel_Dispositivos(), this.getDispositivo(), null, "dispositivos", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(dispositivoEClass, Dispositivo.class, "Dispositivo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getDispositivo_Name(), ecorePackage.getEString(), "name", null, 0, 1, Dispositivo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDispositivo_SuperType(), this.getDispositivo(), null, "superType", null, 0, 1, Dispositivo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDispositivo_Etiquetas(), this.getEtiqueta(), null, "etiquetas", null, 0, -1, Dispositivo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDispositivo_Estados(), this.getEstado(), null, "estados", null, 0, -1, Dispositivo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDispositivo_Eventos(), this.getEvento(), null, "eventos", null, 0, -1, Dispositivo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDispositivo_Transiciones(), this.getTransicion(), null, "transiciones", null, 0, -1, Dispositivo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(etiquetaEClass, Etiqueta.class, "Etiqueta", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getEtiqueta_TypeName(), ecorePackage.getEString(), "typeName", null, 0, 1, Etiqueta.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEtiqueta_Name(), ecorePackage.getEString(), "name", null, 0, 1, Etiqueta.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEtiqueta_Value(), ecorePackage.getEString(), "value", null, 0, 1, Etiqueta.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(eventoEClass, Evento.class, "Evento", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getEvento_TypeName(), ecorePackage.getEString(), "typeName", null, 0, 1, Evento.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getEstado_Elementos(), this.getAbstractElement(), null, "elementos", null, 0, -1, Estado.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(transicionEClass, Transicion.class, "Transicion", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getTransicion_Evento(), this.getEvento(), null, "evento", null, 0, 1, Transicion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getTransicion_Estado(), this.getEstado(), null, "estado", null, 0, 1, Transicion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getIfBlock_Elementos(), this.getAbstractElement(), null, "elementos", null, 0, -1, IfBlock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
